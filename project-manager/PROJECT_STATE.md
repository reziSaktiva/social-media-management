...
### KI-059 · Verifikasi manual browser T-024.4 belum bisa dilakukan (`DATABASE_URL` tidak tersedia)

| Field | Value |
|-------|-------|
| Status | Open |
| Kategori | Gap Verifikasi / Environment |
| Terkait | T-024 (T-024.4) |
...
T-024.4 tetap ditandai selesai di `tasks/v02-publishing-mvp.md` berdasarkan
verifikasi kode yang tersedia, tapi **belum dianggap teruji penuh**
end-to-end. Perlu ditindaklanjuti King Rezi (atau agent dengan akses
environment yang punya `DATABASE_URL`) sebelum T-024 (termasuk T-024.5)
dinyatakan tuntas dan di-QA formal oleh Najwa QA Engineer.
