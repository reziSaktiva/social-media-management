...
| **v0.7** Migrasi Astryx → shadcn/ui | Cross-cutting: ganti fondasi UI component system (ADR-097) | T-095–T-102 | 8    | 3 ✅ · 5 ⏳           | [tasks/v07-astryx-shadcn-migration.md](tasks/v07-astryx-shadcn-migration.md) |

**Total:** 85 task · 28 selesai · 209 subtask terdefinisi (v0.1–v0.3, v0.7).
