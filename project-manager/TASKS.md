...
* Setiap release menyisakan beberapa nomor kosong di akhir sebagai ruang tumbuh (misal T-019 untuk v0.1, T-037–T-039 untuk v0.2).
...
| -------------------------- | -------------------------------------------------- | ----------- | ---- | ------------------- | ---------------------------------------------------- |
| **v0.1** Foundation        | Setup, Auth, Workspace, Connect Account, Settings  | T-001–T-019 | 19   | 🟡 8 ✅ · 1 🚫 · 2 🟡 · 8 ⏳ | [tasks/v01-foundation.md](tasks/v01-foundation.md)         |
...
**Total:** 70 task · 13 selesai · 138 subtask terdefinisi (v0.1–v0.3).
...
| --------- | ----------------------------------------------- | ------ | ---------------------------------------------------- |
| **T-012** | Sidebar section "Channels"                      | 🟡      | T-012.3/4/5/6/9 selesai (kode-level, review Ridwan lolos, QA statis Najwa PASS); T-012.1/2 masih deferred (v0.2), PR #42 belum di-merge. 5 temuan lain dari review PR #42 dipindah ke Known Issues (out-of-scope) |
