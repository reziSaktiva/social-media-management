...
| **v0.7** Migrasi Astryx → shadcn/ui | Cross-cutting: ganti fondasi UI component system (ADR-097) | T-095–T-102 | 8    | 2 ✅ · 6 ⏳           | [tasks/v07-astryx-shadcn-migration.md](tasks/v07-astryx-shadcn-migration.md) |

**Total:** 85 task · 27 selesai · 209 subtask terdefinisi (v0.1–v0.3, v0.7).
...
| --------- | ----------------------------------------------- | ------ | ---------------------------------------------------- |
| **T-096** | Migrasi Core Infra & Shared Primitives           | ✅      | **Selesai (2026-09-01)** — `globals.css`, `Providers.tsx`, root `app/(app)/layout.tsx`, primitive `Button`/`Card`/`Dialog`/`Input`/`Text`. Lihat `tasks/v07-astryx-shadcn-migration.md` § T-096 untuk detail & 2 keputusan penting (CSS/Theme Astryx dipertahankan sementara). T-097 (Migrasi Auth Flows & Onboarding) menyusul sebagai task berikutnya rilis v0.7 |
