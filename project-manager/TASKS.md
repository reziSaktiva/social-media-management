...
| **T-036** | In-app notification + Supabase Realtime         | ⏳      | Root rantai **T-093 → T-036 → T-092** — T-093 (invite+role, ≥2 akun nyata) sudah ✅ Done (2026-08-31), jadi T-036 sekarang giliran berikutnya, tidak lagi terhambat task lain |
