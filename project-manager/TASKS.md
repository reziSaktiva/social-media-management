...
| -------------------------- | -------------------------------------------------- | ----------- | ---- | ------------------- | ---------------------------------------------------- |
| **v0.1** Foundation        | Setup, Auth, Workspace, Connect Account, Settings  | T-001–T-019 | 19   | 🟡 8 ✅ · 1 🚫 · 10 ⏳ | [tasks/v01-foundation.md](tasks/v01-foundation.md)         |
...
**Total:** 69 task · 13 selesai · 134 subtask terdefinisi (v0.1–v0.3).
