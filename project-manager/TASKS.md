...
| **T-036** | In-app notification + Supabase Realtime         | 🟡      | T-036.1/.2 selesai (2026-08-31, domain skeleton + subscribe Realtime). T-036.4 (UI bell+panel) **blocked** — belum ada rancangan di Claude Design, lihat KI-039 |
